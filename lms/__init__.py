...
if language[0] == "de_DE":
    ...
    title = "LXDB MediaSorter Version 1.0.0"
    text_open = "Öffnen"
    ...
    title = "LXDB MediaSorter Версия 1.0.0"
    text_open = "Открыть"
    ...
    title = "LXDB MediaSorter версія 1.0.0"
    text_open = "Bідкрити"
...
class App(QMainWindow):
    ...
    def aboutwindow(self):
        QMessageBox.about(self,
            ...
            """<b>LXDB MediaSorter version 1.0.0</b>
            <br>Get your files in order !
            <p>Copyright &copy; 2019-2021 LXDB Team
